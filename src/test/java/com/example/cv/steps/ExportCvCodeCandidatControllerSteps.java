...
public class ExportCvCodeCandidatControllerSteps {
    ...
    @When("je fais une requête POST sur {string} avec le code candidat :")
    ...
    @Then("la réponse avec le code candidat est {string}")
